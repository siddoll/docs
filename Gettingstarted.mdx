  ...
  <Step title="Step 5 — Summary & generation">
    <AccordionGroup>
      ...
      <Accordion title="Start generation">
        ...
        - **Generation:** initiates **LenseAI** pipeline with **Gemini AI**
      </Accordion>
    </AccordionGroup>
  </Step>
</Steps>
...
- Generating Image — base image creation (Gemini)
...
Frontend: React + TypeScript, responsive UI, image preloading, real-time polling

Backend: Supabase Edge Functions orchestrate AI processing

AI: Google Gemini for image generation

Enhancement: external upscaling service

Credits & Billing: Stripe-backed credit system (1 credit = 1 image)
...
Completion rate: % of users finishing the 5-step flow
...
<Tip>
  ...
  Plans & Credits
  </a> to choose the right subscription and manage your balance. 
</Tip>