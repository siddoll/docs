...
Numbers below are example prices for documentation and UI copy. Final prices are defined in Stripe and can vary by region, tax/VAT, and promotions.
</Callout>
...
* **Monthly credits** based on package (20–50)
* **No Typelense watermark**
* Limited AI model selection
* Standard resolution
* Monthly or yearly billing
* **17% discount** with yearly billing

### Pro <small>(Most popular)</small>

* **Monthly credits** based on package (20–500+)
...
<Steps>
  <Step title="New user">
    Receives <strong>8 free credits</strong>. Watermarked output; limited models; standard resolution.
  </Step>
  <Step title="Monitor credits">
    Sidebar widget shows <strong>credits remaining</strong> and status color.
  </Step>
  <Step title="Low balance">
    Automatic <strong>upgrade prompts</strong> with plan comparison.
  </Step>
  <Step title="Select plan">
    Interactive slider (20–500+), monthly/yearly toggle, and most-popular highlight.
  </Step>
  <Step title="Checkout">
    Stripe Checkout session → successful payment → <strong>instant credit allocation</strong>.
  </Step>
</Steps>
