...
<Frame>
  <img
    src="images/typelense_gettingstarted_screen.webp"
    alt="LenseAI overview"
    className="rounded-lg"
    title="LenseAI overview"
  />
</Frame>
...
<Tip>
  Next up: learn about <a href="/introduction/plans-and-credits">Plans & Credits</a> to choose the right subscription and manage your balance.
</Tip>